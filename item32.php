    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <div class="card mt-4">
            <img class="card-img-top img-fluid" src="http://35.163.12.144/slotyworld/assets/picture/others/drone-dji.jpg" alt="">
            <div class="card-body">
              <h3 class="card-title">
                <?php
                //statement
          ...
          <div class="card card-outline-secondary my-4">
            ...
            <div class="card-body">
              <p>
                <?php
                  //statement
                  $sql = "select commentdetail from ProductComment where productId = 30002";
                  $result = $conn->query($sql);
                  if ($result->num_rows > 0) {
                      // output data of each row
                      while($row = $result->fetch_assoc()) {
